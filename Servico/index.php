...
<html lang="pt-br">
    ...
    <body>
        ...
        echo "</div>";
            ...
            $sql = "select * from servico inner join unidade ON unidade.idunidade= Unidade_idunidade where idunidade like '%$asdf%' ";

                            //$sql = "select * from unidade_servico where Unidade_idunidade=2";
