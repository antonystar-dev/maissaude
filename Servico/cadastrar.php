                ...
                <div class="row">
                    ...
                    <form class="form-horizontal" action="cadastrar.php" method="post">
                        ...
                        <div class="control-group <?php echo!empty($descricaoErro) ? 'error ' : ''; ?>">
                            ...
                            <div class="controls">
                                <input size="50" name="descricao" type="text" placeholder="Descrição do serviço" required="" value="<?php echo!empty($descricao) ? $descricao : ''; ?>">
...
if (!empty($_POST)) {
    ...
    $validacao = true;
    if (empty($nome)) {
        $nomeErro = 'Preencha todos os campos';
        $validacao = false;
    }


    if (empty($descricao)) {
        $descricaoErro = 'Preencha todos os campos';
        $validacao = false;
    }
    ...
    if ($validacao) {
        ...
        $q = $pdo->prepare($sql);
        $q->execute(array($nome, $descricao, $disponivel, $asdf));
        Banco::desconectar();
